...
const infoData = [
  {
    icon: <User2 size={20} />,
    text: "Obie Jagad Prakoso",
  },
  {
    icon: <PhoneCall size={20} />,
    text: "+62 896 4790 4777",
  },
  {
    icon: <MailIcon size={20} />,
    text: "obieprakoso@gmail.com",
  },
  {
  ...
  },
  {
    ...
    text: "Bachelor's degree in informatics engineering",
  },
  {
    icon: <HomeIcon size={20} />,
    text: "Tambun Selatan, Bekasi, Indonesia",
  },
];
...
const qualificationData = [
  ...
  },
  {
    ...
    data: [
      {
        company: "PT.Reycom Document Solusi (RDS)",
      ...
      {
        company: "PT.Quadrant Synergy International",
        role: "Beckend Developer (Team Lead)",
        years: "2021 - 2024",
      },
      {
        company: "PT Rpay Finansial Digital Indonesia",
        role: "Frontend Developer (WEB)",
        years: "2024 - present",
      },
    ],
          ...
          <div className="flex-1">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-w-[520px] xl:border dark:border-none">
                <TabsTrigger className="w-[162] xl:w-auto" value="personal">
                  Personal Info
                </TabsTrigger>
                <TabsTrigger
                  className="w-[162] xl:w-auto"
                  value="qualifications"
                >
                  Qualifications
                </TabsTrigger>
                <TabsTrigger className="w-[162] xl:w-auto" value="skills">
                  Skills
                </TabsTrigger>
              </TabsList>
